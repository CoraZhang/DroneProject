...
my %Sensor = (
    # "Temperature" => "d524bb47-4693-4d47-ac06-9343f6615c33",
    # "Door" => "41231ece-609a-4a28-8e47-438d7dc7830a",
    # "Tilt" => "a26227a0-6ed3-4b70-a363-6b247495c0f3"
   );
...
sub readSensorConfig
{
 ...
 if(open(CONF, $sensorFile))
   ...
   { &error("Cannot read sensor config file: $sensorFile"); }
}
